...
- **Who speaks here** works out who says each quoted line of a chapter — `qwen3:14b` through Ollama,
  ...
  man" for a page and then names him needs. The list says where you first meet each of them, chapter
  and part, and **💬** shows their lines. Narrating it afterwards takes no longer than one voice does. Once a book has
